...
class TorchLanguage:
    ...
    def update(  # type: ignore
        ...
        golds: Sequence[Union[Dict[str, Any], Any]],
        optimizer: Optimizer,
        verbose: bool = False,
    ):
    ...
    def _update_pipes(self, docs: Sequence[Doc], golds: Sequence[Any]) -> None:
    ...
    def evaluate(  # type: ignore
        self,
        docs_golds: Sequence[Tuple[Union[str, Doc], Union[Dict[str, Any], Any]]],
        batch_size: int = 16,
