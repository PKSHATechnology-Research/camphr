...
def conll_ner2json(input_data, n_sents=..., seg_sents: bool = ..., model: Optional[Any] = ..., no_print: bool = ..., **kwargs):
    """
...
def segment_sents_and_docs(doc, n_sents, doc_delimiter, model: Optional[Any] = ..., msg: Optional[Any] = ...):
    ...
