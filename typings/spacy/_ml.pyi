...
@describe.attributes(W=Synapses("Weights matrix", lambda obj: (obj.nO, obj.nI), lambda W, ops: None))
...
def build_bow_text_classifier(nr_class, ngram_size=..., exclusive_classes: bool = ..., no_output_layer: bool = ..., **cfg):
    ...
...
@describe.attributes(nM=Dimension("Vector dimensions"), nC=Dimension("Number of characters per word"), vectors=Synapses("Embed matrix", lambda obj: (obj.nC, obj.nV, obj.nM), _uniform_init(- 0.1, 0.1)), d_vectors=Gradient("vectors"))
